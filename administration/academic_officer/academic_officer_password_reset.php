...
<head>
    ...
    <title>academic officer reset password</title>
...
<body>
    <main class="page">
        <div class="card">
            ...
            <a class="back_link" href="academic_officer_login.php">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        $(document).ready(function(){
            ...
            $('#reg_btn').click(function(event) {
                ...
                if (code == '' || pwd == '' || confirm_pwd == '') {
                    ...
                    $('#error').text('please fill all spaces provided......');
                    $('#form')[0].reset();
                    ...
                    if (pwd != confirm_pwd) {
                        ...
                        if (pwd.length < 8) {
                            ...
                            $.ajax({
                                ...
                                data: {action: 'academic officer reset password', code: code, confirm_pwd: confirm_pwd, pwd: pwd, token: token},
                                method: 'POST',
                                dataType: 'text',
                                beforeSend: function(){
                                ...
                                success: function(data){
                                    ...
                                    if (data == 'updated') {
                                        ...
                                        window.location.assign("academic_officer_login.php?result='reset_pwd'");

...
<head>
    ...
    <title>admin officer reset password</title>
                    ...
                    if (pwd != confirm_pwd) {
                        ...
                        if (pwd.length < 8) {
                            ...
                            $.ajax({
                                ...
                                data: {action: 'admin officer reset password', code: code, confirm_pwd: confirm_pwd, pwd: pwd, token: token},
                                method: 'POST',
                                dataType: 'text',
                                beforeSend: function(){
                                ...
                                success: function(data){
                                    ...
                                    if (data == 'updated') {
                                        ...
                                        window.location.assign("admin_officer_login.php?result='reset_pwd'");

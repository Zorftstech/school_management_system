...
<head>
    ...
    <title>exam officer reset password</title>
...
<body>
    <main class="page">
        <div class="card">
            ...
            <a class="back_link" href="exam_officer_login.php">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    if (pwd != confirm_pwd) {
                        ...
                        if (pwd.length < 8) {
                            ...
                            $.ajax({
                                ...
                                data: {action: 'exam officer reset password', code: code, confirm_pwd: confirm_pwd, pwd: pwd, token: token},
                                method: 'POST',
                                dataType: 'text',
                                beforeSend: function(){
                                ...
                                success: function(data){
                                    ...
                                    if (data == 'updated') {
                                        ...
                                        window.location.assign("exam_officer_login.php?result='reset_pwd'");

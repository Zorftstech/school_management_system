...
if (isset($_POST['submit'])) {
    ...
    $query = "SELECT * FROM finance_clerk_registration_table WHERE email = '$email'";
    ...
    if ($num > 0) {
        ...
        $query_two = "UPDATE finance_clerk_registration_table SET pwd_code = '$pwd_code', pwd_token = '$pwd_token' WHERE email = '$email'";

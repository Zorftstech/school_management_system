...
<?php
    ...
    $page_title = 'add pupils to voucher';
...
?>
    ...
    <div id="form_container">
        ...
        <h2>add pupils to school fees payment voucher</h2>
            ...
            $('#submit').click(function(event) {
                ...
                if (addmission_num == '' || classe == '' || term == ''  || session == '' || voucher_num == '') {
                    ...
                    $.ajax({
                        ...
                        data: {action: 'add pupil to school fees payment voucher', class: classe, addmission_num, term, session, voucher_num},
                        method: 'POST',
                        dataType: 'text',

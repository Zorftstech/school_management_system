<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($session) || empty($class) || empty($term)) {
            ...
            header("location: class_voucher_generate_form.php?fail=$fail");
            exit();
...
<?php
    ...
    $page_title = 'student voucher generation form';
    $page_css = array('../admin_officer/css/student_registration_form_css.css');
            ...
            $('#submit').click(function (event) {
               ...
               if (school_fees == '' || pta == '' || metainance == '' || lesson == '' || other == '') {
                    ...
                    $.ajax({
                        ...
                        data: {action: 'generate class voucher', class: classe, term, session, email, user, school_fees, pta, metainance, lesson, other},
                        method: 'POST',
                        dataType: 'text',

<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($session) || empty($term)) {
            ...
            header("location: class_voucher_details_form.php?fail=$fail");
            exit();
            ...
            if (!preg_match($session_reg, $session)) {
                ...
                $query = "SELECT * FROM class_voucher_table WHERE term = '$term' AND session = '$session'";
                    ...
                    <tbody>
                        ...
                        <?php
                            ...
                            while ($row = mysqli_fetch_array($query_run)) {
                                ...
                                $edit = '<a href="class_voucher_editing_form.php?id='.$id.'" class="edit_btn" id="edit'.$id.'" data-id="'.$id.'">edit</a>';

<?php 
    ...
    $query = "SELECT * FROM class_voucher_table WHERE id = '$id'";
...
<?php
    ...
    $page_title = 'student class voucher update form';
            ...
            $('#submit').click(function (event) {
               ...
               if (school_fees == '' || pta == '' || metainance == '' || lesson == '' || other == '') {
                    ...
                    $.ajax({
                        ...
                        data: {action: 'class voucher update', class: classe, school_fees, pta, metainance, lesson, other, id, status, term, session},
                        method: 'POST',
                        dataType: 'text',

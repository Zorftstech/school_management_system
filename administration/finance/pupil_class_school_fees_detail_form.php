...
<?php
    ...
    $page_title = 'pupils class school fees detail form';
...
?>
    ...
    <div id="form_container">
        ...
        <h2>pupils class school fees details form</h2>
        ...
        <form action="pupil_class_school_fees_detail_view.php"  method="POST">

<?php 
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($session) || empty($term) || empty($class) || empty($voucher_num)) {
            ...
            header("location: pupil_class_school_fees_detail_form.php?fail=$fail");
            exit();
...
<?php
    ...
    $page_title = 'pupil class school fees details view';
                    ...
                    <tbody>
                        ...
                        <?php
                            ...
                            while ($row = mysqli_fetch_array($query_run)) {
                                ...
                                $view = '<a href="single_pupil_transaction_detail_view.php?id='.$id.'&addmission_num='.$addmission_num.'&class='.$class.'&term='.$term.'&session='.$session.'&name='.$name.'" class="view_btn" id="view'.$id.'" data-id="'.$id.'">view</a>';

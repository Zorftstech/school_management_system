<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($session) || empty($term)) {
            ...
            header("location: pupil_withdrawer_form.php?fail=$fail");
            exit();
...
<?php
    ...
    $page_title = 'primary school withdraw amount enter form';
    $page_css = array('css/school_deposit_amount_enter_css.css');
...
<style>
    ...
    <section id="transactio_container">
        ...
        <section id="transaction_head">
            ...
            <p><span class="tranc_key"> slip type: </span> <span class="tranc_item">withdrawal</span></p>
        </section>
        ...
        $(document).ready(function(){
            ...
            $('#submit').click(function(event){
               ...
               if (amount == '' || description == '') {
                   ...
                   if (confirm(`do you want to withdraw ₦${amount}.00`)) {
                       
                        $.ajax({
                            url: 'action_php/multipurpose_action.php',
                            data: {action: 'withdrawing money from primary school withdraw table', amount, description, term, session},
                            method: 'POST',
                            dataType: 'text',

                            beforeSend: function() {
                                
                                $('#submit').val('withdrawing......');

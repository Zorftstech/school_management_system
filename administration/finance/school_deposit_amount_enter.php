<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($session) || empty($term)) {
            ...
            header("location: deposit_form.php?fail=$fail");
            exit();
...
<?php
    ...
    $page_title = 'secondary deposit amount enter form';
               ...
               if (amount == '' || description == '') {
                   ...
                   if (confirm(`do you want to deposit ₦${amount}.00`)) {
                        ...
                        $.ajax({
                            ...
                            data: {action: 'depositing money into school deposit table', amount, description, term, session},
                            method: 'POST',
                            dataType: 'text',

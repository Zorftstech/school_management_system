<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($session) || empty($term)) {
            ...
            header("location: deposit_details_form.php?fail=$fail");
            exit();
            ...
            if (!preg_match($session_reg, $session)) {
                ...
                $query = "SELECT * FROM school_deposit_transaction_table WHERE session = '$session' AND term = '$term'";
...
<?php
    ...
    $page_title = 'secondary school deposit details view';

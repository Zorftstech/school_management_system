<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($session) || empty($term)) {
            ...
            header("location: withdrawer_form.php?fail=$fail");
            exit();
...
<?php
    ...
    $page_title = 'secondary school withdraw amount enter form';
               ...
               if (amount == '' || description == '') {
                   ...
                   if (confirm(`do you want to withdraw ₦${amount}.00`)) {
                        ...
                        $.ajax({
                            ...
                            data: {action: 'withdrawing money from school withdraw table', amount, description, term, session},
                            method: 'POST',
                            dataType: 'text',

...
<?php
    ...
    $page_title = 'single pupils school fees detail form';
...
?>
    ...
    <div id="form_container">
        ...
        <h2>single pupils school fees details form</h2>
        ...
        <form action="single_pupil_school_fees_detail_view.php"  method="POST">

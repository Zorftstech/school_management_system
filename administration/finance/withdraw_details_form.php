...
<?php
    ...
    $page_title = 'secondary school withdrawal details form';
...
?>
    ...
    <div id="form_container">
        ...
        <h2>secondary school withdrawal details form</h2>
        ...
        <form action="school_withdraw_details_view.php"  method="POST">

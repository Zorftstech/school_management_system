...
<div class="container">
  ...
  <div class="card">
    ...
    <div class="card-header">
        <h3>Exam officer details</h3>
        <p id="error"></p>
        <a class="btn-ghost" href="exam_officer_registration.php">Register new</a>
    </div>
    ...
    <div class="modal fade" id="myModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <h4 class="modal-title">Exam Officer Update form</h4>
...
<script>
    ...
    $(document).ready(function(){
         ...
         // function to load exam officer detail,,,,,,,,,,
         ...
         function load_exam_data() {
            ...
            $.ajax({
                ...
                data: {action: 'load exam officer data'},
                method: 'POST',
                dataType: 'text',
        ...
        // retriving exam officer data for update........
        ...
        $(document).on('click', '.edit_btn', function(event) {
           ...
           $.ajax({
               url: 'action_php/multipurpose_action.php',
               data: {action: 'fetch exam officer data', id: id},
               method: 'POST',
               dataType: 'json',
       ...
       $('#update_btn').click(function(event) {
          ...
          $.ajax({
               ...
               url: 'action_php/multipurpose_action.php',
               data: {action: 'update exam officer data', id: id, user: user, status: status},
               method: 'POST',
               dataType: 'text',
               beforeSend: function(){
       ...
       $(document).on('click', '.delete_btn', function(event) {
           ...
           $.ajax({
               url: 'action_php/multipurpose_action.php',
               data: {action: 'delete exam officer data', id: id},
               method: 'POST',
               dataType: 'text',
               beforeSend: function(){

...
<div class="container">
  ...
  <div class="card">
    ...
    <div class="card-header">
        <h3>finance clerk officer details</h3>
        <p id="error"></p>
        <a class="btn-ghost" href="finance_officer_registration.php">Register new</a>
    </div>
    ...
    <div class="modal fade" id="myModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <h4 class="modal-title">finance clerk Update form</h4>
    ...
    $(document).ready(function(){
         ...
         function load_academic_data() {
            ...
            $.ajax({
                ...
                data: {action: 'load finance clerk data'},
                method: 'POST',
                dataType: 'text',
        ...
        $(document).on('click', '.edit_btn', function(event) {
           ...
           $.ajax({
               url: 'action_php/multipurpose_action.php',
               data: {action: 'fetch finance clerk data', id: id},
               method: 'POST',
               dataType: 'json',
       ...
       $('#update_btn').click(function(event) {
          ...
          $.ajax({
               ...
               url: 'action_php/multipurpose_action.php',
               data: {action: 'update finance clerk data', id: id, user: user, status: status},
               method: 'POST',
               dataType: 'text',
               beforeSend: function(){
       ...
       $(document).on('click', '.delete_btn', function(event) {
           ...
           $.ajax({
               url: 'action_php/multipurpose_action.php',
               data: {action: 'dele academic officer data', id: id},
               method: 'POST',
               dataType: 'text',
               beforeSend: function(){

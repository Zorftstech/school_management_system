...
if (isset($_POST['submit'])) {
    ...
    $query = "SELECT * FROM admin_registration_table WHERE email = '$email'";
    ...
    if ($num > 0) {
        ...
        $query_two = "UPDATE admin_registration_table SET pwd_code = '$pwd_code', pwd_token = '$pwd_token' WHERE email = '$email'";
        ...
        if ($query_run_two) {
            ...
            if ($mail->send()) {
                ...
                header("location: ../admin_officer_password_reset.php?token=$pwd_token");

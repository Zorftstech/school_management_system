...
if (isset($_POST['submit'])) {
    ...
    $query = "SELECT * FROM student_attendance_creation_table WHERE email = '$email' AND term = '$term' AND session = '$session'";
    ...
    if ($num > 0) {
        ...
        $query_two = "UPDATE student_attendance_creation_table SET pwd_code = '$pwd_code', pwd_token = '$pwd_token' WHERE email = '$email' AND term = '$term' AND session = '$session'";
